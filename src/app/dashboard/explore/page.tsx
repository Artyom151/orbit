...
import { Search, Users, Newspaper, Compass, AtSign, TrendingUp, Group as GroupIcon } from "lucide-react";
      ...
      <Tabs defaultValue="foryou" className="w-full">
        <TabsList className="grid w-full grid-cols-4 bg-transparent border-b rounded-none">
          <TabsTrigger value="foryou">
              <Compass className="sm:mr-2" />
              <span className="hidden sm:inline">For You</span>
            </TabsTrigger>
          <TabsTrigger value="trending">
              <TrendingUp className="sm:mr-2" />
              <span className="hidden sm:inline">Trending</span>
          </TabsTrigger>
          <TabsTrigger value="users">
              <AtSign className="sm:mr-2" />
              <span className="hidden sm:inline">Users</span>
          </TabsTrigger>
          <TabsTrigger value="groups">
              <GroupIcon className="sm:mr-2" />
